        ...
        <form onSubmit={handleSubmit} className="create-orphanage-form">
          <fieldset>
            ...
            <div className="input-block">
              ...
              <input multiple onChange={handleSelectedImages} type="file" id="image[]"></input>
          ...
          <fieldset>
            ...
            <div className="input-block">
              <label htmlFor="opening_hours">Horário de Visistação</label>
